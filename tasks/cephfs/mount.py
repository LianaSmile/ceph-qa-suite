...
class CephFSMount(object):
    def __init__(self, test_dir, client_id, client_remote,cluster_name='xtao'):
        """
    ...
    def get_keyring_path(self):
        ...
        return '/etc/ceph/xtao.client.{id}.keyring'.format(id=self.client_id)
    ...
    def run_shell(self, args, wait=True):
        ...
        if p.exitstatus == 0:
            ...
            log.info('Liyan {mountpoint} is not mounted'.format(mountpoint=self.mountpoint))
