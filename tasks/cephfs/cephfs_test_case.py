...
# Liyan notes this ,it conflict with fuse_mount
...
class CephFSTestCase(CephTestCase):
    ...
    def setUp(self):
        ...
        # Peng debug currently not support automatically delete all filesystems
        ...
        try:
            # Peng hammer doesnt support now, comment it out for hammer testing
            #self.mds_cluster.mon_manager.raw_cluster_cmd("osd", "blacklist", "clear")
            log.info("Peng doesnot support osd blacklist clear in hammer")
        ...
        if self.REQUIRE_FILESYSTEM:
            # Peng debug comment out the if block
    ...
    def tearDown(self):
        ...
        # can shu you wen ti shao can shu
